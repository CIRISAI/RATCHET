...
echo "" | tee -a "${RUN_LOG}"
echo "Next: run override_scoring on data/crossfamily_5vendor/ to verify OR-1/OR-2/RA-1." | tee -a "${RUN_LOG}"
echo "  python3 experiments/exp1b_boundary_active/run_override_scoring.py \\" | tee -a "${RUN_LOG}"
echo "    --crossfamily-dir experiments/exp1b_boundary_active/data/crossfamily_5vendor" | tee -a "${RUN_LOG}"
