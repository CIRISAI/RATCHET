...
\textbf{Two of the six have fired; two are unmet; one is unresolved; one passes.}
...
Settling the corridor needs a fragility measure validated to be $\keff$-independent before it is
used --- detection latency at fixed false-positive rate is the remaining candidate --- and that
is the specific outstanding instrument problem.
